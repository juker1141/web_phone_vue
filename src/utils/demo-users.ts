...
if (token === '') {
  token = randomString(
    32,
    ['0123456789', 'abcdefghijklmnopqrstuvwxyz', 'ABCDEFGHIJKLMNOPQRSTUVWXYZ'].join('')
  )
  const d = new Date()
...
const domain = 'turn.realtime.tw'

export const nameAlice = '601'
export const uriAlice = 'sip:601' + '@' + domain
export const webSocketServerAlice = 'wss://turn.realtime.tw/ws'

export const nameBob = '600'
export const uriBob = 'sip:600' + '@' + domain
export const webSocketServerBob = 'wss://turn.realtime.tw/ws'
